...
const events: PublicEvent[] = [
    ...
    options: [
      {
        id: 5001,
        eventId: 1001,
        name: "Accès coupe-file",
        description: "Entrée prioritaire.",
        price: 6
      }
    ],
    tables: [
      {
        ...
        eventId: 1001,
        name: "Table Sunset",
        description: "Table réservée pour le groupe.",
        fullPrice: 240,
  ...
  },
  {
    ...
    address: "Moll de la Marina, Barcelona",
    type: "boat_party",
    description:
  ...
  {
    id: 1003,
    name: "B4F Night Experience",
    location: "The Club Barcelona",
    address: "Barcelona",
    type: "nightclubs",
    description:
    ...
    options: [
      {
        ...
        eventId: 1003,
        name: "Fast pass",
        description: "File d’entrée dédiée.",
        price: 7
      }
    ],
    tables: []
...
export const demoPacks: PublicPack[] = [
  {
    id: "demo-pack-1",
    name: "B4F Weekend Pass",
    description:
    ...
    womenSold: 52,
    menSold: 61,
    imageUrl: media.crowd,
    colorName: "Orange",
    colorHex: "#fb923c",
    soldout: false,
    earliestEventDate: events[0].eventDate,
    events: [
      {
        id: "demo-pe-1",
        packId: "demo-pack-1",
      ...
      },
      {
        ...
        eventId: events[2].id,
        eventType: "choice",
        choiceGroupKey: "night",
        choiceGroupTitle: "Choisissez votre soirée",
        minChoices: 1,
        maxChoices: 1,
        event: events[2],
        options: events[2].options,
        tables: []
      },
      {
        id: "demo-pe-3",
