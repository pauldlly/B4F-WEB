...
export declare const handleUserInput: (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>, { country, insertDialCodeOnEmpty, phoneBeforeInput, prefix, charAfterDialCode, forceDialCode, disableDialCodeAndPrefix, countryGuessingEnabled, defaultMask, disableFormatting, countries, allowMaskOverflow, }: HandleUserInputOptions) => {
    phone: string;
    inputValue: string;
