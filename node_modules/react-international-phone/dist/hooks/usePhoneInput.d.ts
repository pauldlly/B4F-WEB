...
export declare const usePhoneInput: ({ defaultCountry, value, countries, prefix, defaultMask, charAfterDialCode, historySaveDebounceMS, disableCountryGuess, disableDialCodePrefill, forceDialCode: forceDialCodeConfig, disableDialCodeAndPrefix, disableFormatting, allowMaskOverflow, onChange, inputRef: inputRefProp, }: UsePhoneInputConfig) => {
    phone: string;
    inputValue: string;
    country: ParsedCountry;
